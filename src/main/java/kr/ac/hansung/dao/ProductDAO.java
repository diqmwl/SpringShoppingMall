...
public class ProductDAO {
	...
	public boolean insert(Product product) {
		...
		return jdbcTemplate.update(sqlStatement, new Object[] {product_name, product_price, product_desc, product_url}) == 1;
	}
	...
	public boolean reviewinsert(Review review) {
		...
		return jdbcTemplate.update(sqlStatement, new Object[] {username, product_name, review_desc, score, date}) == 1;
	}
